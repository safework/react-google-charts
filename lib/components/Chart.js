...
var Chart = (function (_React$Component) {
  ...
  _createClass(Chart, [{
    key: 'handleChartError',
    value: function handleChartError(e) {
      var errorHandler = this.props.errorHandler;

      var container = document.getElementById(this.state.graphID);
      container.innerHTML = '';
    ...
    value: function drawChart() {
      ...
      google.visualization.events.addOneTimeListener(this.wrapper, 'error', function (e) {
        return _this3.handleChartError(e);
      });
      this.wrapper.draw();
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement('div', { id: this.state.graphID, style: divStyle });
    }
  }]);
